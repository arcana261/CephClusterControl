...
class ClientLoop extends RabbitClient {
  ...
  _callBase(target, method, args, {timeout = 0, broadcast = false, publish = true}) {
  ...
  broadcastType(targetType, method, args, {timeout = 0} = {}) {
    return this._callBase(`${targetType}.?`, method, args,
      {timeout: timeout, broadcast: true, publish: true});
  }

  broadcastHost(hostname, method, args, {timeout = 0} = {}) {
